export const TableSkeleton = () => {
  return (
    ...
    //     <tr>
    //       <th className="py3 px-6">#</th>
    //       <th className="py3 px-6">Name</th>
    //       <th className="py3 px-6">Phone</th>
    //       <th className="py3 px-6">Created At</th>
    //       <th className="py3 px-6 textce">Action</th>
    //     </tr>
    //   </thead>
      ...
      <tbody className="bg-white divide-y divide-gray-200 ">
        {/* {contacts.map((contact, index) => ( */}
          ...
          <tr>
              ...
              <div className="inline-flex items-center gap-x-3">
                <div className="flex items-center gap-x-2">
                  <div>
                    ...
                    <div className="h-2 mt-1 w-20 rounded bg-gray-100"></div>
            ...
            <td className="px-4 py-4 text-sm text-gray-500"><div className="h-4 w-20 rounded bg-gray-100"></div></td>

            {/* <td className="px-4 py-4 text-sm text-gray-500">
              {contact.nomorVa}
            </td> */}

            <td className="px-4 py-4 text-sm text-gray-500"><div className="h-4 w-28 rounded bg-gray-100"></div></td>
            <td className="px-4 py-4 text-sm text-gray-500"><div className="h-4 w-20 rounded bg-gray-100"></div></td>
